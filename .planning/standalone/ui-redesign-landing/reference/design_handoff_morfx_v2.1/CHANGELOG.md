...
## v2.1 · landing añadida

- **Añadido** `mocks/landing.html` (869 líneas) — sitio público de marketing con header sticky, hero, secciones de producto, features, pricing, FAQ y footer. Carga `../colors_and_type.css` y usa las texturas de papel en `body` con `background-attachment: fixed`.
- README §4: tabla actualizada a **9 módulos** (módulo #0 = Landing).
- Orden de implementación: landing puede ir en paralelo — es bundle/rutas independientes del app shell.
