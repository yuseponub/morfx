/**
 * Somnio v4 — Declarative Transition Table
 *
 ...
 * Cloned mecánicamente desde somnio-v3/transitions.ts (D-24).
 * D-28/D-29: stages + pipelines compartidos vía crm_query_tools_config — UUIDs no-hardcoded
 * en este archivo (transitions usa nombres simbólicos como 'crear_orden'; los UUIDs viven
 * en delivery-zones / future invocation handlers).
 */
