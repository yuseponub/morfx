...
7. Level 2 should fire silently (no visible message in chat) and transition mode to ofrecer_promos
8. **Immediately after Level 2 fires silently**, verify the timer countdown now shows Level 3 "Promos sin respuesta" with its own countdown starting (automatic chaining from L2 to L3)
