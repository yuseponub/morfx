...
/**
 * GoDentist FB/IG Sibling Agent — Comprehension Prompt
 *
 ...
 *
 * Sibling de GoDentist (D-04). Lead-capture examples agregados (D-11) para
 * reforzar la clasificacion del primer turno post-saludo como `intent='datos'`.
 */
...
Clasificacion:
  ...
  reasoning = "Cliente envio nombre completo + celular como respuesta directa al saludo lead-capture"
...
Clasificacion:
  ...
  reasoning = "Cliente envio nombre + celular + sede en un solo mensaje (datos criticos completos)"
