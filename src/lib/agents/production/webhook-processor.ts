 ...
 * Checks contact_tags via the conversation's linked contact (source of truth).
 */
async function conversationHasAnyTag(
  ...
  // Step 1: Get contact_id from conversation
  ...
  // Step 2: Check contact_tags for matching tag names
