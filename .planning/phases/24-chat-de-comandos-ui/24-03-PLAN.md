...
<task type="auto">
  ...
  **handleToggleExpand:**
  ...
  `getJobItemsForHistory` is already exported from `src/app/actions/comandos.ts` (defined in Plan 24-02).
  Import it: `import { getJobItemsForHistory } from '@/app/actions/comandos'`
