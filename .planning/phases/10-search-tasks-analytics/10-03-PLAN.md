...
- Pre-fill the task form with entity context
  ...
  <verify>
1. Contact detail /crm/contactos/[id] - verify "Tareas" tab exists in tab navigation
2. Click "Tareas" tab - contact-tasks component renders with filtered task list for this contact
3. CreateTaskButton in contact-tasks - click opens form with contact pre-filled
4. Order sheet - task button visible in header, creates task linked to order
5. WhatsApp contact panel - task button visible, creates task linked to conversation
  </verify>
  <done>
