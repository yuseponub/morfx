// Cloned verbatim from src/lib/agents/godentist-fb-ig/guards.ts (Standalone agent-varixcenter Wave 1).
// Solo cambia el import de constants a ./constants de varixcenter; cuerpo idéntico.
/**
 * Varixcenter Agent — Cross-cutting Guards
 *
 * Run BEFORE phase derivation and transition table.
 * R0: Low confidence + otro -> handoff
 * R1: Escape intents (asesor, reagendamiento, cancelar_cita, queja, paciente_antiguo) -> handoff
 */
