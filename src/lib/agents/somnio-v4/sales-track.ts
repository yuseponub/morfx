/**
 * Somnio Sales Agent v4 — Sales Track (Two-Track Decision)
 *
 ...
 * Cloned mecánicamente desde somnio-v3/sales-track.ts (D-24).
 */
...
export function resolveSalesTrack(input: {
  ...
  if (event.type === 'timer_expired') {
    ...
    console.warn(`[sales-track-v4] No transition for timer_expired:${event.level} in phase ${phase}`)
