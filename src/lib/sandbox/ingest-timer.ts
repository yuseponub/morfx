...
export const TIMER_DEFAULTS: TimerConfig = {
  levels: { 0: 600, 1: 360, 2: 120, 3: 600, 4: 600, 5: 90, 6: 360, 7: 120, 8: 120 },
}

export const TIMER_PRESETS: Record<TimerPreset, TimerConfig> = {
  real: { levels: { 0: 600, 1: 360, 2: 120, 3: 600, 4: 600, 5: 90, 6: 360, 7: 120, 8: 120 } },
  rapido: { levels: { 0: 60, 1: 30, 2: 10, 3: 60, 4: 60, 5: 9, 6: 30, 7: 10, 8: 10 } },
  instantaneo: { levels: { 0: 2, 1: 2, 2: 1, 3: 2, 4: 2, 5: 1, 6: 2, 7: 1, 8: 1 } },
}
