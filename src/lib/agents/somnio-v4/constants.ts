/**
 * Somnio Sales Agent v4 — Constants
 *
 * Single source of truth. ZERO imports from other project files.
 * Prevents circular dependencies.
 *
 * Standalone: somnio-sales-v4
 * Cloned mecánicamente desde somnio-v3/constants.ts (D-24).
 * Diferencia clave: V4_META_PREFIX='_v4:' para aislar session_state (D-30).
 */

// ============================================================================
// V4 Intents (22 total — only REAL client intents)
// ============================================================================

export const V4_INTENTS = [
  // Informational (13)
  'saludo',
  'precio',
  'promociones',
...
/**
 * V4 metadata prefix — D-30 isolation.
 * v3 sessions use '_v3:' so v4 must use '_v4:' to avoid key collisions in
 * session_state.datos_capturados. Both prefixes can theoretically coexist.
 */
export const V4_META_PREFIX = '_v4:'
...
// ============================================================================
// V4 Timer Durations (Quick-028: V3 Production Timer System — heredado D-21)
// ============================================================================

/**
 * Timer durations per preset per level (in SECONDS).
 * Values are IDENTICAL to V3 (D-21 — heredar 3 timer levels sin cambios).
 ...
 */
export const V4_TIMER_DURATIONS: Record<string, Record<number, number>> = {
