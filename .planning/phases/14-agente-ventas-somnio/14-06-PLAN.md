...
3. processMessage implementation:
   ...
   5. If compra_confirmada, use OrderCreator
...
3. API route validates input and handles errors
4. Sessions created and tracked correctly
5. Tool execution logs captured for tracing
