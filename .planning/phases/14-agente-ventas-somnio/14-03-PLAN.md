...
must_haves:
  ...
  # VTAS-10 Clarification: Per CONTEXT.md, configurable prices are DEFERRED to post-MVP.
  # For MVP, prices are hardcoded in SOMNIO_PRICES constant (3 tiers: 1x, 2x, 3x).
  # This is intentional and satisfies VTAS-10 requirement for "3 price configurations".
  artifacts:
