...
must_haves:
  truths:
    - "Data Extractor extracts 9 customer fields from messages"
    - "Phone numbers normalize to 57XXXXXXXXXX format"
    - "Cities normalize to proper case (bogota -> Bogota)"
    - "Departamento inferred from known cities (Bogota -> Cundinamarca)"
    - "Negations detected (no tengo correo -> correo = N/A)"
  artifacts:
...
normalizeAddress('cll 45 # 23-10') === 'Calle 45 # 23-10'
