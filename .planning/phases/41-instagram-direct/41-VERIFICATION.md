...
gaps:
  ...
  - id: GAP-41-08
    ...
    status: fixed (plan 41-13, shipped 2026-06-06 — commits b37070a4/0d872f0e; TDD 8/8; reclassify mp4/mov audio-only → audio gated IG/FB; WhatsApp untouched Regla 6; verified live: same file as audio → Meta 200 FB+IG; awaiting operator live smoke: re-send chat-downloaded .mp4 audio → delivers)
human_verification:
