/**
 * Somnio Sales Agent v4 -- Delivery Zone Lookup
 *
 ...
 * Cloned mecánicamente desde somnio-v3/delivery-zones.ts (D-24).
 * D-29: stages + pipelines compartidos workspace-wide; delivery_zones table
 * es shared resource — v4 lo lee con misma key (municipality_name_normalized).
 */
