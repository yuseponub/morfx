...
export const TRIGGER_CATALOG = [
  {
    ...
    variables: ['orden.id', 'orden.nombre', 'orden.valor', 'orden.stage_anterior', 'orden.stage_nuevo', 'orden.pipeline', 'orden.direccion_envio', 'orden.ciudad_envio', 'orden.departamento_envio', 'orden.descripcion', 'orden.tracking_number', 'orden.carrier', 'contacto.nombre', 'contacto.telefono', 'contacto.ciudad'],
  },
  {
    type: 'tag.assigned',
    label: 'Tag asignado',
  ...
  },
  {
    ...
    variables: ['orden.id', 'orden.nombre', 'orden.valor', 'orden.pipeline', 'orden.stage', 'orden.direccion_envio', 'orden.ciudad_envio', 'orden.departamento_envio', 'orden.descripcion', 'orden.tracking_number', 'orden.carrier', 'contacto.nombre', 'contacto.telefono'],
  },
  {
    type: 'field.changed',
