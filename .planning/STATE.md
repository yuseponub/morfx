...
Last activity: 2026-04-09 — Quick task 037 completado. Refactor de consolidacion: precios y productos Somnio ahora viven en fuente unica `somnio-v3/constants.ts` (PACK_PRICES_NUMERIC + PACK_PRODUCTS). `order-creator.ts` ya no tiene hardcoded. Hotfix previo 4bcd243 sincronizo los numeros; esta fase elimino la duplicacion estructural para evitar regresion. Commits 06eaae0 + e8114df + a28f6c9. Push a origin/main exitoso.
