...
must_haves:
  truths:
    - "Automatizaciones se pueden almacenar y consultar en la DB aisladas por workspace (RLS activo)"
    - "El codigo que construya sobre estos tipos tiene seguridad de tipos para triggers, condiciones y acciones"
    - "El wizard de automatizaciones (Plan 05) puede leer catalogos de triggers, acciones y variables para mostrar opciones disponibles al usuario"
  artifacts:
