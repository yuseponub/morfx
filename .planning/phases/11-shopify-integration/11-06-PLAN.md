...
<task type="auto">
  ...
  <action>
Create the Shopify configuration form with the 'name' field visible for user-friendly identification:
...
Key features:
- **Integration name field visible** at the top for user identification
...
- Active/inactive toggle
  ...
  <verify>Form renders and validates. Test connection button works. Name field is visible and editable.</verify>
  <done>ShopifyForm allows full configuration of Shopify integration with validation including display name.</done>
</task>
...
3. Form validates required fields including name
