 ...
 * Standalone godentist-block-wednesday-morning — Plan 01 (agente godentist / WhatsApp).
 * El robot Dentos se mockea vía global.fetch.
 */
...
describe('checkDentosAvailability — bloqueo miércoles mañana (Punto A)', () => {
