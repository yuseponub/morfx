-- ============================================================================
-- Somnio Agent Templates - CLEAN VERSION
-- Todos los mensajes en una sola línea excepto los que necesitan saltos
-- ============================================================================
...
-- ============================================================================
-- METODOS_DE_PAGO (este SÍ tiene saltos de línea intencionales)
-- ============================================================================
INSERT INTO agent_templates (agent_id, intent, visit_type, orden, content_type, content, delay_s) VALUES
...
-- ============================================================================
-- INFO_PROMOCIONES (tiene saltos intencionales para bullets)
-- ============================================================================
INSERT INTO agent_templates (agent_id, intent, visit_type, orden, content_type, content, delay_s) VALUES
...
-- ============================================================================
-- CAPTURA_DATOS_SI_COMPRA (tiene saltos intencionales)
-- ============================================================================
INSERT INTO agent_templates (agent_id, intent, visit_type, orden, content_type, content, delay_s) VALUES
...
-- ============================================================================
-- OFRECER_PROMOS (tiene saltos intencionales)
-- ============================================================================
INSERT INTO agent_templates (agent_id, intent, visit_type, orden, content_type, content, delay_s) VALUES
...
-- ============================================================================
-- NO_CONFIRMADO, NO_INTERESA, FALLBACK
-- ============================================================================
INSERT INTO agent_templates (agent_id, intent, visit_type, orden, content_type, content, delay_s) VALUES
...
-- Verificación
-- ============================================================================
SELECT intent, visit_type, COUNT(*) as total FROM agent_templates WHERE agent_id = 'somnio-sales-v1' GROUP BY intent, visit_type ORDER BY intent;
